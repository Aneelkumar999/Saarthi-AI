            ...
            <div>
              ...
              <div className="glass-panel mt-8 rounded-[2rem] p-3 shadow-civic">
                <div className="flex flex-col gap-3 sm:flex-row">
                  <Link href="/chat" className="flex flex-1 items-center gap-3 rounded-2xl bg-white px-4 py-4">
                  ...
                  <button className="rounded-2xl border border-slate-200 bg-white px-4 text-slate-600" aria-label="Use voice" onClick={() => alert("Voice input coming soon!")}><Mic /></button>
                </div>
              </div>
              <div className="mt-6 flex flex-wrap gap-3 text-sm font-semibold text-slate-600">
                <Link href="/chat" className="rounded-full bg-white px-4 py-2 transition hover:bg-slate-100">Trade License</Link>
                <Link href="/chat" className="rounded-full bg-white px-4 py-2 transition hover:bg-slate-100">Birth Certificate</Link>
                <Link href="/chat" className="rounded-full bg-white px-4 py-2 transition hover:bg-slate-100">Farm Schemes</Link>
                <Link href="/chat" className="rounded-full bg-white px-4 py-2 transition hover:bg-slate-100">Land Registration</Link>
              </div>
            </div>
